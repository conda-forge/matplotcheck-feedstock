About matplotcheck-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/matplotcheck-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7320&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/matplotcheck-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `matplotcheck` can be installed with `conda`:
...
```
mamba install matplotcheck
```

It is possible to list all of the versions of `matplotcheck` available on your platform with `conda`:
...
```
mamba search matplotcheck --channel conda-forge
```
...
mamba repoquery search matplotcheck --channel conda-forge

# List packages depending on `matplotcheck`:
mamba repoquery whoneeds matplotcheck --channel conda-forge

# List dependencies of `matplotcheck`:
mamba repoquery depends matplotcheck --channel conda-forge
```
